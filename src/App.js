...
import CodingCanvasSection from './CodingCanvasSection'; // Import the new CodingCanvasSection component
...
const FundingSection = ({ themeClasses }) => {
  ...
  const allInvestors = [
    ...
    { name: 'Growth Ventures', details: 'EdTech, SaaS', logo: 'GV', industry: 'SaaS', stage: 'Europe', investment: '$100k - $500k' },
